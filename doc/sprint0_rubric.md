...
**Team Name:** [Cyclist]  
**Github:** [https://github.com/UTSCCSCC01/finalprojects22-cyclist]  
...
## summary.md (Max 8 marks)
  ...
  - Principles have been described clearly (max 2 marks)
    ...
    Your mark: 1
    Feedback: Should not include project specific implementations here. You should talk more about the app overall behaviour. Like You focus on User satisfication, Cohesiveness, User friendly app and so on. No need to mention like "Never show too many tasks at once: Providing an overview to users is essential, but the side effect is to overwhelm users" Try to see what does this achieve and summarize that.
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  Feedback: You already have enough userstories but you might want to shrink a few and look at from admin perspective, like statistic of the number of users who have already signed up, time spent using the app e.t.c
...
## Setup (max 3 marks)
  ...
  Feedback: You should atleast have some basic setup done soon. I don't see any frontend or backend setup. 
---
## Documentation: README.md (max 3 marks)
  ...
  - Contribution
    ...
    Feedback: You should have develop branch not separate frontend/backend branch. Develop contains the final running code before merging to the main. If you make frontend and backend separate branches how will you test the functionality of Backend with Frontend as a whole?  
...
## Definition of done: done.md (max 2 marks)
  ...
  Feedback: Need to elaborate more further. What kind of tests? Unit tests? What about team approval? 
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1 
    Feedback: Should mention how did you split your work in Sprint 0. Like Member x worked on Readme, and so on ..
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 1
    Feedback: Does not clearly mention how would you prioritize the user story? Any strategy for point estimation like planning poker? Would you first work on the user stories that lay the foundation for the website? Need to elaborate more on this
