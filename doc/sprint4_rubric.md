...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Commit messages missing ticket number
...
## Sprint Demo (Max 14 marks) 
  - Attendance (max 2 marks) (7 Members)
  ...
  - Working software (max 8 marks)
    ...
    Your Mark: 7  (Last feature shown did not work properly (suggested time))
  ...
  1 - Dashboard
  2 - Complete Rate
  3 - Task time analysis
  4 - Task completion 
  5 - Debugging

  Feedback: Logos for weather could be better. Also when setting the story to complete or selecting the other option, mouse should display click logo instead of line bar
