...
Your Mark: 3
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Note: Should elaborate more on Team Capacity. How does your estimate point map to working hour
...
## Daily Stand-ups (max 10 marks)
  ...
  Note: Going forward, make sure to post the standup on the same day, I noticed one to two standups were posted on next day.
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    - Pull Requests do not corresponds to the task. Also two pull requests (CYC-34, CYC-58) refer to the tasks that were removed from Sprint 1 
  ...
  Your Mark: 1
    ...
    - Does not see pull requests for either of CYC-38,60,63,66 or its tasks
...
Your Mark: 2 
  ...
  - Same as previous. Do not see the pull requests for CYC-38,60,63,66 or its tasks
...
Your Mark: 1 
  ...
  - Lot of commit messages missing ticket number. I gave you 1 mark still since one member from your team told about your team not knowing about the format. 
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  - Cover Page and Table of Contents (max 2 marks)
    ...
    - Need to have a separate page for cover page and table of contents
  ...
  - CRC Cards [or equivalent, if the team is not using CRC) (max 4 marks)
    ...
    - Should follow the CRC card tempelate or equivalent
    - Collaborators not clearly mentioned for few classes
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    - It seems more of Three-tier architecture rather than MVC. Please check Three-tier architecture.
